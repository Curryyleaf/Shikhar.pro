<template>
  ...
  <nav class="bg-white fixed top-0 left-0 right-0 pt-3 z-50">
    ...
    >
      ...
      <div
        class="hidden w-full md:block md:w-auto text-gray-500"
        id="navbar-dropdown "
      >
        <ul
        ...
        <nav class="flex ml-6 h-10 text-white items-center justify-center">
          ...
          <router-link
            to="/cart"
            class="ml-auto mr-2 hover:text-gray-900 focus:text-gray-900"
          >
            <span class="ml-auto">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                ...
                viewBox="0 0 16 16"
                aria-label="cart"
                aria-roledescription="Navigate to cart on click"
              >
                <path
          ...
          <li class="ml-4">
            <button
              class="border-2 border-gray-300 rounded-lg p-1 text-xs hover:text-sm"
              @click="logout"
            >
              Logout
            </button>
