<template>
  {{ product.image }}
  <div v-if="product" class="font-sans bg-white mt-20 ">
    <div class="p-4 lg:max-w-7xl max-w-4xl mx-auto ">
        ...
        <div class="lg:col-span-2">
          ...
          <div class="flex flex-wrap gap-4 mt-8">
            <input
              ...
              class="min-w-[200px] px-4 py-3 bg-gray-300 hover:bg-gray-400 text-white text-sm font-semibold rounded"
            />
      ...
      <div class="mt-16 shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)] p-6">
        ...
        <ul class="mt-4 space-y-6 text-gray-800">
          ...
          <li class="text-sm">
            product material<span class="ml-4 float-right">xxxxxxxx</span>
          </li>
          <li class="text-sm">
            Sizes <span class="ml-4 float-right">xxxxxxxx</span>
          </li>
          <li class="text-sm">
            Color<span class="ml-4 float-right">xxxxxxxx</span>
          </li>
          <li class="text-sm">
            Dimensions<span class="ml-4 float-right">xxxxxxxx</span>
          </li>
          <li class="text-sm">
            Weight <span class="ml-4 float-right">xxxxxxxx</span>
          </li>
          <li class="text-sm">
            Box includes <span class="ml-4 float-right"> xxxxxxxx </span>
          </li>
          <li class="text-sm">
            Serial Number <span class="ml-4 float-right">xxxxxxxx</span>
          </li>
        </ul>
      </div>
...
export default {
  ...
  methods: {
    ...
    addToCart(productId) {
        const store= useStore()
      store.addToCart(productId, this.quantity);
