  ...
  <section class="h-screen w-screen grid grid-rows-[auto_1fr]">
      ...
      <nav aria-label="menu nav" class="h-auto p-4 mx-auto bg-white w-full">
        <div class="flex items-center justify-between">
          ...
          <ul class="flex items-center space-x-6 text-gray-800">
            <li><a class="py-2 px-4 hover:bg-gray-100 rounded-full transition" href="#">User</a></li>
            <li><a class="py-2 px-4 hover:bg-gray-100 rounded-full transition" href="#">Notifications</a></li>
            <li class="relative">
    ...
    <main class="grid grid-cols-5  gap-2 w-full h-full overflow-hidden">
      ...
      <li
        ...
        :key="index"
        :class="{
          'bg-blue-500 text-white hover:bg-blue-400': selectedItem === item,
          'bg-gray-100 text-gray-700': selectedItem !== item,
          'font-semibold text-center p-3 rounded-md hover:bg-gray-200 transition': true
        }"
